...
import secrets
import requests
# Removi o 'textwrap', não vamos mais precisar dele.
...
class EmailService:
    ...
    def enviar_convite_projeto(self, email_convidado, nome_convidado, nome_projeto, nome_convidante, token_convite):
        ...
        # === INÍCIO DA CORREÇÃO ===
        # O HTML agora fica dentro de parênteses () e o f""" começa na COLUNA 1 (sem espaços).
        # Isso VAI PARECER "quebrado" ou "desalinhado" no seu editor, mas é INTENCIONAL.
        # É a forma mais segura de evitar erros de indentação no Python.
        
        mensagem_html = (
f"""<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    def enviar_redefinicao_senha(self, email_usuario, nome_usuario, token_redefinicao):
        ...
        # === INÍCIO DA CORREÇÃO ===
        # Aplicando a MESMA correção de indentação aqui.
        mensagem_html = (
f"""<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
